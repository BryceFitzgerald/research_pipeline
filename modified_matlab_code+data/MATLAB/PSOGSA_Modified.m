function [probabilityOfSuccess, averageObjectiveFunctionEvaluations, InHours, InMinutes, InSeconds] = PSOGSA_Modified(TestFunctionIdentificationNumber,NumberOfDimensions,NumberOfIterationsToFindTheAverage)
    ...
    probabilityOfSuccess = NumberOfSuccesses/NumberOfIterationsToFindTheAverage
    averageObjectiveFunctionEvaluations = ceil(SumOfObjectiveFunctionEvaluations/NumberOfSuccesses)
end