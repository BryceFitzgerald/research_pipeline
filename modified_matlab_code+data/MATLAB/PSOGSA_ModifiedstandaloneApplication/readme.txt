...
-run_PSOGSA_Modified.sh (shell script for temporarily setting environment variables and 
   ...
   -to run the shell script, type
       ...
       ./run_PSOGSA_Modified.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v910, run the shell script as:
       ...
       ./run_PSOGSA_Modified.sh /mathworks/home/application/v910
...
${DYLD_LIBRARY_PATH}:MR/v910/runtime/maci64:MR/v910/sys/os/maci64:MR/v910/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_PSOGSA_Modified.sh 
