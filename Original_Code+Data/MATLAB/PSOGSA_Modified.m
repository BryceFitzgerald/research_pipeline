...
% Input parameters.
TestFunctionIdentificationNumber = 2; % <-- Enter the test function identification number here.
NumberOfDimensions = 500; % <-- Enter the dimensions of the test function here.
NumberOfIterationsToFindTheAverage = 10;
...
for i = 1:n
    ...
    disp(['Successes: ' num2str(NumberOfSuccesses) ', Run: ' num2str(jj) ', Iteration ' num2str(iter) ': Best Cost = '...
